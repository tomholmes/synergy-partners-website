          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
                SynergyIQ helps banks, insurers, and fintechs baseline AI maturity, align with model risk and regulatory guidance, and execute roadmaps that turn pilots into compliant, measurable value.
              </p>
