...
function EmailCaptureSimple({ source = "homepage" }) {
    ...
    try {
      ...
      const response = await fetch('https://formspree.io/f/xdkogkpv', {
        ...
        body: JSON.stringify({
          ...
          _subject: `New Lead: ${formData.firstName} ${formData.lastName} from ${formData.organization}`,
          _cc: 'tholmes@synergypartners.ai'
        })
      })
      ...
      setStatus('error')
      setMessage('Something went wrong. Please try again or contact us directly at tholmes@synergypartners.ai')
    }
  }
...
export default EmailCaptureSimple
